const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of Inova and retrieve knowledge from that knowledge base.',
  ...
  intro1: 'The Knowledge can be integrated into the Inova application ',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
  intro5: 'can be created',
  intro6: ' as a standalone plug-in to publish',
